...
class Usuario(Base):
    ...
    reviews_avaliado = relationship('Riview', back_populates='avaliado', foreign_keys='Riview.id_avaliado')
    reviews_avaliador = relationship('Riview', back_populates='avaliador', foreign_keys='Riview.id_avaliador')
    ...
    messages_received = relationship(
        "Message",
        foreign_keys="Message.id_receiver",
